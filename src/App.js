...
function App() {
  ...
  `}</style>
        <div className="container mx-auto my-5 " style={{ maxWidth: "1100px" }}>
            ...
            MovieInfo.Title && (
              <div className="row">
                ...
                <div className={`col-md-7 text-${mode ? "dark" : "light"}`}>
                  ...
                  <h5 className="my-2">Duration :- {MovieInfo.Runtime}</h5>
                  <h5 className="my-2">Director :- {MovieInfo.Director}</h5>
                  <h5 className="my-2">Actors :- {MovieInfo.Actors}</h5>
                  <h5 className="my-2">Writers :- {MovieInfo.Writer}</h5>
                  <h5 className="my-2">Countries :- {MovieInfo.Country}</h5>
                  <h5 className="my-2">Languages :- {MovieInfo.Language}</h5>
                  <h5 className="my-2">Box office :- {MovieInfo.BoxOffice}</h5>
